      ...
      <div id="heading-breadcrumbs" style="background: url('<?php echo base_url();?>assets/img/texture-bw.png') center center repeat; background-size: cover;">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Hadiah Wisuda</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/hadiah">Hadiah</a></li>
          ...
          <div class="row bar">
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm category-menu">
                    <li class="nav-item"><a href="shop-category.html" class="nav-link d-flex align-items-center justify-content-between"><span>Pria </span></a>
                    ...
                    <li class="nav-item"><a href="shop-category.html" class="nav-link active d-flex align-items-center justify-content-between"><span>Hadiah Wisuda</span></a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-lg-9">
              <div id="productMain" class="row">
                <div class="col-sm-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div> <img src="<?php echo base_url();?>assets/img/Gift/p1.jpg" alt="" class="img-fluid"></div>
                    <div> <img src="<?php echo base_url();?>assets/img/Gift/p1-1.jpg" alt="" class="img-fluid"></div>
                    <div> <img src="<?php echo base_url();?>assets/img/Gift/p1-2.jpg" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="box">
                    <form>
                      ...
                      <p class="text-center">
                      <a href="<?php echo base_url();?>index.php/checkout" class="btn btn-template-outlined" style="margin-top: -10px;><i class="fa fa-shopping-cart"></i>Keranjang</a>
                      
                      </p>
                    </form>
                  </div>
                  <div data-slider-id="1" class="owl-thumbs" style="margin-top: -40px;">
                    <button class="owl-thumb-item"><img src="<?php echo base_url();?>assets/img/Gift/p1.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="<?php echo base_url();?>assets/img/Gift/p1-1.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="<?php echo base_url();?>assets/img/Gift/p1-2.jpg" alt="" class="img-fluid"></button>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    <div class="image"><a href="#"><img src="<?php echo base_url();?>assets/img/Gift/g2.jpg" alt="" class="img-fluid image1"></a></div>
                    <div class="text">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    <div class="image"><a href="#"><img src="<?php echo base_url();?>assets/img/Gift/g6.jpg" alt="" class="img-fluid image1"></a></div>
                    <div class="text">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    <div class="image"><a href="#"><img src="<?php echo base_url();?>assets/img/Gift/p3.jpg" alt="" class="img-fluid image1"></a></div>
                    <div class="text">
